<section class="terminal-panel">
    ...
    <p>
        I watch a lot of longer YouTube videos and I found it very annoying to lose my progress when
        I reload tabs, or close the browser.
    </p>

    <p>
        I originally generated this in a single prompt to ChatGPT Codex after getting a 1 month free
        Pro subscription. I then took it from there.
    </p>
</section>
...
<section class="terminal-panel">
    ...
    <p>
        ...
        <a href="https://github.com/poltak/timestamp-goblin">GitHub</a>.
    </p>
</section>
